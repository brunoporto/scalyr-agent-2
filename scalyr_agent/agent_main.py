...
class ScalyrAgent(object):
    ...
    def __init__(self, platform_controller):
        ...
        self.__additional_config_dir = None
    ...
    def main(self, config_file_path, command, command_options):
        ...
        self.__additional_config_dir = Configuration.get_additional_config_dir(
            command_options.additional_config_dir
        )
    ...
    def __make_config(self, config_file_path):
        ...
        return Configuration(
            ...
            log,
            additional_config_dir=self.__additional_config_dir,
        )
...
if __name__ == "__main__":
    ...
    parser.add_option(
        ...
        default=None,
        help="An additional directory to check for configuration files",
        metavar="PATH",
    )
    parser.add_option(
        "-q",
